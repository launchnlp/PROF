...
output_dir=/home/inair/data/revision_saves/mwrite_specificity_dpo_8b_instruct_temp_0.7_openai
...
working_data_path=/home/inair/argument_revision/LLaMA-Factory/data/test_ranking.json
num_train_epochs=20
student_type=normal
...
do
    ...
    python feedback_generation/feedback_filtering_openai.py --input_file $output_dir/feedback_$((i-1)).json --model_path $model_path --adapter_path $output_dir/adapter_$((i-1)) --exploration_size $exploration_size --student_model $student_model --reward_model gpt-35-turbo --student_system_prompt $student_system_prompt --reward_system_prompt $reward_system_prompt  --output_file $feedback_intermediate_path --model_device $model_device --max_num_samples $max_num_samples --student_type $student_type --dpo --student_temperature $student_temperature
